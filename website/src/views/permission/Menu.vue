                  ...
                  <Form ref="formData" :model="formData" :rules="ruleValidate" :label-width="80" style="width: 500px">
                        ...
                        <FormItem label="所属系统" prop="system">
                         ...
                         <FormItem label="属性" prop="attrs">
                            <Input v-model="formData.attrs" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="json"></Input>
                        </FormItem>
        ...
        methods: {
                    ...
                    if (valid) {
                        ...
                        if(this.menuId <= 0) {
                            let params = {
                             ...
                             this.$axios
                                 .post(this.$API.PERMISSION_MENU_ADD, params)
                                 .then(response => {
                            ...
                            let params = {
                             ...
                             this.$axios
                                 .post(this.$API.PERMISSION_MENU_EDIT, params)
                                 .then(response => {
                                    console.log(response);
                                    if(response.data && response.data.rc == '0') {
                                        this.$Message.success('成功!');
            ...
            queryData() {
                ...
                if(id > 0) {
                    ...
                    this.$axios
                     .post(this.$API.PERMISSION_MENU_SHOW, params)
                     .then(response => {
                        console.log(response);
                        if(response.data && response.data.rc == '0') {
