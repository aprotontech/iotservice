    ...
    <div class="main-box">
      ...
      <div class="mode-box">
        ...
        <div class="mode-content" style="white-space: pre-wrap">
          <el-table :data="deviceSecret" border style="width: 100%">
            <el-table-column prop="pub_key" label="公钥" align="center">
            ...
            <el-table-column prop="token" label="会话" align="center">
            </el-table-column>
          </el-table>
        </div>
      </div>
            ...
            this.deviceInfo = [
              {
                ...
                uuid: m.basic.uuid,
                activeTime: m.basic.active_time
                  ? m.basic.active_time
                  : "未激活",
              ...
              this.deviceLocation = [
                {
                  ...
                  updateTime: m.location.updated_at
